  ...
  return (
    <div className="home-container">
      ...
      <div className="container mt-3">
        <div className="transfer-box">
          ...
          <div className="upi-info"> 
            <small onClick={handleReceiveMoneyClick}>
              UPI ID: 1234567890@ybl <FontAwesomeIcon icon={faQrcode} />
            </small>
          </div>
        </div>
      </div>
        ...
        <div className="wallet-box">
          <div className="row">
            {[
              ...
              { icon: faCreditCard, label: "Credit Card", onClick: handleWalletClick },
              { icon:   faEarthAmericas, label: "Foreign Exchange ", onClick: handleWalletClick },
      ...
      <div className="footer-nav">
        <div className="footer-icon" onClick={handleBackClick}>
          <FontAwesomeIcon icon={faHome} />
          <span>Home</span>
        </div>

        <div className="scanner-btn" onClick={handleScannerClick}>
          <FontAwesomeIcon icon={faQrcode} />
        </div>

        <div className="footer-icon" onClick={handleHistoryClick}>
